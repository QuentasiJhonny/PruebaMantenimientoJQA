 ...
 */
/**
 *  Resolucion de tableros Sudoki.
 *
 *  Se usa un algoritmo de prueba y error, y se basa
 *  en mantener tablas con informacion de que numeros ya han sido usados en cada
 *  fila, columna, y subcuadrado (3x3).
 */
class Sudoku {
